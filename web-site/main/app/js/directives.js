angular.module('mpost.directives', []).
    // Custom directives
    directive('minMaxForm', function () {
        return {
            restrict: 'E',
            templateUrl: appHelper.templatePath('common/min-max-form')
        };
    }).
    ...
    directive('required', function () {
        return {
            restrict: 'E',
            templateUrl: appHelper.templatePath('common/required')
        };
    }).

    directive('autosuggestion', function () {
        return {
            restrict: 'E',
            replace: true,
            transclude: true,
            ...
            templateUrl: appHelper.templatePath('common/auto-suggestion'),
