...
angular.module('mpost.factory', []).
    factory('Company', function ($resource) {
        return $resource('/mpost/services/company/:id');
    }).
    factory('ComList', function ($resource) {
        return $resource('/mpost/services/com-list/:id');
    }).
    factory('Reseller', function ($resource) {
        return $resource('/mpost/services/reseller/:id');
    }).
    factory('SaleChannel', function ($resource) {
        return $resource('/mpost/services/sale-channel/:id');
    }).
    factory('ShopManager', function ($resource) {
        return $resource('/mpost/services/shop-manager/:id');
    }).
    factory('TerminalStock', function ($resource) {
        return $resource('/mpost/services/terminal-stock/:id');
    }).
    factory('GAB', function ($resource) {
        return $resource('/mpost/services/gab/:id');
    }).
    factory('Terminal', function ($resource) {
        return $resource('/mpost/services/terminal/:id');
    }).
    factory('Product', function ($resource) {
        return $resource('/mpost/services/product/:id');
    }).
    factory('Contact', function($resource) {
        return $resource('/mpost/services/contact/:id');
    }).
    factory('Shop', function($resource) {
        return $resource('/mpost/services/shop/:id');
    }).
    factory('Documents', function($resource) {
        return $resource('/mpost/services/delivery/:id');
    }).
    factory('ClosedConvention', function($resource) {
        return $resource('/mpost/services/terminal/close-convention/:id');
    }).
    factory('Supplier', function ($resource) {
        return $resource('/mpost/services/supplier/:id');
    }).
    factory('TerminalType', function ($resource) {
        return $resource('/mpost/services/terminal-type/:id');
    }).
    factory('TerminalStock', function ($resource) {
        return $resource('/mpost/services/terminal-stock/:id');
    }).
    factory('Service', function ($resource) {
        return $resource('/mpost/services/service/:id');
    }).
